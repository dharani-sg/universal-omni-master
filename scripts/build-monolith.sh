...
TOOLS="omni-detect omni-service omni-boot omni-gpu omni-storage omni-audit omni-deploy omni-healer omni-snapshot omni-security omni-fleet omni-manifest omni-saas omni-patcher omni-compliance omni-openclaw omni-desktop"
